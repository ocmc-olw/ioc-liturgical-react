...
export class SearchAbbreviations extends React.Component {
  ...
  componentWillMount = () => {
    ...
    let path = this.props.session.restServer + Server.getDbServerDropdownsSearchAbbreviationsApi();
  ...
  setTheState = (props, docType) => {
    ...
    let theSearchLabels = Labels.getSearchAbbreviationLabels(props.session.languageCode);
...
SearchAbbreviations.defaultProps = {
  initialType: "*"
};


export default SearchAbbreviations;