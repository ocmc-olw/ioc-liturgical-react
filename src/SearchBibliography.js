...
export class SearchBibliography extends React.Component {
  ...
  setTheState = (props, docType) => {
    ...
    let theSearchLabels = Labels.getSearchBibliographyLabels(props.session.languageCode);
...
SearchBibliography.defaultProps = {
  initialType: "*"
};


export default SearchBibliography;