...
const   labels = {
  en: {
    ...
    , SearchGeneric: {
      ...
      , msg6: "To edit, click the radio button of the row you are interested in."
    ...
    , TextNoteEditor: {
      type: "Type"
      , bibleRef: "Bible Ref"
      , biblicalScope: "Biblical Heading"
      , biblicalLemma: "Biblical Sub-Heading"
      , ids: "IDs"
      , settings: "Settings"
      ...
      , noteLibrary: "Note"
      , id: "ID of this note"
      , liturgicalHeadingLibrary: "Liturgical Heading"
      , liturgicalSubHeadingLibrary: "Liturgical Sub-Heading"
      , biblicalGreekLibrary: "Biblical Heading"
      , biblicalTranslationLibrary: "Biblical Sub-Heading"
      , liturgicalScope: "Heading"
      , liturgicalLemma: "Sub-Heading A"
      , note: "Note"
      , order: "Order"
      , title: "Sub-Heading B"
      , refersTo: "Refers to"
      , revisions: "Revisions"
      , selectPredecessor: "Select the note you want this one to follow"
      , setTypeScope: "Set Type and Headings"
    ...
    , ParaTextEditor: {
      ...
      , valueFor: "Value for"
      , submit: "Submit"
      , includeAdviceNotes: "Include translation advice notes?"
    ...
    , messages: {
      ...
      , ok: "OK"
      , preparingPdf: "Preparing the PDF. This can take several minutes."
    ...
    button: {
      cancel: "Διαγραφή"
      , checkId: "Έλεγχος αναγνωριστικού"
      , close: "Κλείσιμο"
      , createFiles: "Δημιουργία αρχείων"
      , delete: "Delete"
      , downloadAsPdf: "Διαβίβαση σε PDF"
      , downloadAsTex: " Διαβίβαση σε LaTeX"
      , remove: "Αφαίρεση"
    ...
    , deleteButton: {
      danger: "Κίνδυνος!"
      , yesDelete: "Ναι, διαγραφή καταχώρησης"
      , msg1: "Αν επιβεβαιώσετε τη διαγραφή, η καταχώρηση και οι σχέσεις της με άλλες καταχωρήσεις θα διαγραφεί. Αυτό δεν μπορεί να αναιρεθεί."
    }
    , SearchGeneric: {
      title: "Αναζήτήστε, δημιουργήστε ή επεξεργαστείτε Καταχωρήσεις χρησιμοποιώντας το Σχέδιο Εκδότη."
      , instructions: "Το Σχέδιο Εκδότη παρέχει χρήσιμα μέσα για τη δημιουργία και επεξεργασία μερικών τύπων καταχωρήσεων. Δεν είναι όμορφο περιβάλλον αλλά κάνει σωστά τη δουλειά του! Μπορούμε να χρησιμοποιήσουμε Συντομογραφίες, Καταχωρήσεις Βιβλιογραφίας και Οντολογικοί Φορείς."
      , prompt: "εισάγετε μια λέξη ή μια φράση"
      , clickTheButton: "Πληκτρολογήστε το κουμπί παρακάτω για να υποβάλετε τα κριτήρια αναζήτησης..."
      , findWhereTypeIs: "Βρείτε ποιος τύπος είναι..."
      , domainIs: "και ο τομέας είναι..."
      , propertyIs: "και η ιδιοκτησία είναι..."
      , propertyTextIs: "και έχει αυτό το κείμενο..."
      , matcherIs: "που ταιριάζει..."
      , matchesAtTheStart: "στην αρχή"
      , matchesAtTheEnd: "στο τέλος"
      , matchesAnywhere: "οπουδήποτε"
      , matchesRegEx: "ως τακτική έκφραση"
      , msg1: "Τα σημαντικά μηνύματα εμφανίζονται εδώ..."
      , msg2: "Αναζήτηση..."
      , foundMany: "Βρέθηκαν"
      , foundOne: "Δεν βρέθηκε κανένα"
      , foundNone: "Βρήκα ένα"
      , msg4: "Καταχωρήσεις"
      , msg5: "Μπορείτε να χρησιμοποιείτε το κουτί (κουτιά) παρακάτω για να φιλτράρετε τα αποτελέσματα."
      , msg6: "Για επεξεργασία, πληκτρολογείστε το κουμπί της επιλογής σας από τη σειρά."
      , pageTitle: "Προσθήκη, Εύρεση, Επεξεργασία Καταχωρήσεων με τη Χρήση του Σχεδίου Εκδότη"
      , resultLabel: "Αναζήτηση αποτελέσματος"
      , close: "Κλείσιμο"
      , has: "και έχουν"
      , tags: "από αυτές τις ετικέτες"
      , typeAll: "όλα"
      , tagsAny: "τίποτα"
      , creating: "Δημιουργία..."
      , created: "Δημιουργημένο"
      , submit: "Υποβολή"
      , submitting: "Υποβεβλημένο..."
      , exists: "υπάρχει ήδη..."
      , textPrompt: "εισάγετε κείμενο για αναζήτηση εδώ"
      , createTitle: "Δημιουργήστε μια Νέα Καταχώρηση"
    }
    , schemaBasedAddButton: {
      dummy: "πρόχειρο"
    }
    , ChangePasswordPage: {
      doNotMatch: "Ο νέος κωδικός πρόσβασης και η επανάληψη κωδικού πρόσβασης δεν ταιριάζουν."
      , changed: "Ο κωδικός πρόσβασής σας έχει αλλάξει επιτυχώς."
    }
    , TextNoteEditor: {
      type: "Τύπος"
      , bibleRef: "Αναφ.στη Βίβλο"
      , biblicalScope: "Βιβλική Τίτλος"
      , biblicalLemma: "Βιβλικός Υπότιτλος"
      , ids: "IDs"
      , settings: "Ρυθμίσεις"
      , typeLabel: "παρακαλώ εφαρμόστε τον τύπο σημείωσης στο πλήκτρο των ρυθμίσεων"
      , dbIds: "Χρησιμοποιήστε τα βελάκια για να επιλέξετε τις βιβλιοθήκες που χρησιμοποιείτε για τις σημειώσεις..."
      , noteLibrary: "Σημείωση"
      , id: "ID σημείωσης"
      , liturgicalHeadingLibrary: "Τίτλος Λειτουργίας"
      , liturgicalSubHeadingLibrary: "Υπότιτλος λειτουργίας"
      , biblicalGreekLibrary: "Τίτλος Βίβλου"
      , biblicalTranslationLibrary: "Υπότιτλος Βίβλου"
      , liturgicalScope: "Τίτλος"
      , liturgicalLemma: "Υπότιτλος Α´"
      , note: "Σημείωση"
      , order: "Σειρά"
      , title: "Υπότιτλος Β´"
      , refersTo: "Αναφέρεται σε"
      , revisions: "Αναθεωρήσεις"
      , setTypeScope: "Ορίστε τον Τύπο Σημείωσης και τους Τίτλους"
      , selectPredecessor: "Επιλέξτε τη σημείωση που θέλετε να ακολουθήσει αυτή η σημείωση"
      , viewLiturgicalText: "Προβολή Κειμένου Λειτουργίας"
      , viewBiblicalText: "Προβολή Κειμένου Βίβλου"
      , viewFormattedNote: "Προεπισκόπηση"
      , tags: "Ετικέτες"
      , workflow: "Ροή εργασίας"
      , requiredMsg: "Η σημείωση και τα πεδία στο πλήκτρο ρυθμίσεων είναι υποχρεωτικά."
      , createTitle: "Δημιουργήστε μια Νέα Καταχώρηση Βιβλιογραφίας"
    }
    , WorkflowForm: {
    ...
    , liturgicalAcronyms: {
      baptism: "Βάφτιση"
      , funeral: "Κηδεία"
      , funeral_brightweek: "Ευχολόγιο (Μεγάλη Εβδομάδα)"
      , li: "Θεία Λειτουργία"
      , greatwaterblessing: "Αγιασμός Νερών (Μεγάλος)"
      , hymnbystnektarios: "Ύμνος του Αγίου "
      , ma: "Όρθρος"
      , matinsordinary: "Όρθρος (Κανονικός)"
      , matinsordinary_paschal: "Όρθρος (Κανονικός - Πασχαλινός)"
      , matinsordinary_ascension: "Όρθρος (Κανονικός - Ανάληψη)"
      , ma2: "Όρθρος – (όλες οι επιλογές)"
      , memorial: "Μνημόσυνο"
      , smallwaterblessing: "Αγιασμός Νερών (Μικρός)"
      , unction: "Ευχέλαιο"
      , ve: "Εσπερινοί"
      , wedding: "Γάμος"
    }
    , treebanksResultsTable: {
      ...
      , headerChildLabel: "Π.Σχέση"
      , headerChildToken: "Π.Λέξη"
      , headerChildLemma: "Π.Λήμμα"
    ...
    , pageAbout: {
      ...
      , para04s1: "Τα αναγνωριστικά που χρησιμοποιούνται για τον εντοπισμό μερών των κειμένων των Ακολουθιών δημιουργήθηκαν από τον Πατέρα Σεραφείμ Δέδες και χρησιμοποιούνται στο AGES Liturgical Workbench  (AWB). Το AWB αναπτύχθηκε από το OCMC και"
    ...
    , messages: {
      ...
      , submit: "Submit"
      , regEx: "Enter Regex"
      , clearFilters: "Καθαρίστε τα φίλτρα"
      , filter: "You can use the box(es) below to filter the results."
      , click: "Click the radio button of the row you are interested in."
      , readOnly: "Μπορείτε να το δείτε αλλά να μην το επεξεργαστείτε"
      , ok: "Εντάξει"
      , preparingPdf: "Προετοιμασία του PDF. Αυτό μπορεί να διαρκέσει αρκετά λεπτά..."
...
module.exports = {
  ...
  , getDeleteButtonLabels: (code) => { return labels[code].deleteButton }
