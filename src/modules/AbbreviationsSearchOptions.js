...
class AbbreviationsSearchOptions extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      labels: {
        thisClass: Labels.getSearchAbbreviationLabels(languageCode)
  ...
  getTypeRow = () => {
    return (
        <Row className="show-grid App-Abbreviations-Search-Options-Row">
          <Col xs={12} md={12}>
            <div className={"App App-Abbreviations-Type-Selector"}>
              <ResourceSelector
  ...
  getHasTagRow = () => {
    return (
        <Row className="show-grid App-Abbreviations-Search-Options-Row">
          <Col xs={12} md={12}>
            <div className={"App App-Abbreviations-Tag-Selector"}>
              <ResourceSelector
  ...
  getButtonRow = () => {
    return (
        <Row className="show-grid App-Abbreviations-Search-Options-Row">
          <Col xs={12} md={12}>
            <div className={"App App-Abbreviations-Selector-Button"}>
...
AbbreviationsSearchOptions.propTypes = {
...
export default AbbreviationsSearchOptions;