...
class BibliographySearchOptions extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      labels: {
        thisClass: Labels.getSearchBibliographyLabels(languageCode)
...
BibliographySearchOptions.propTypes = {
...
export default BibliographySearchOptions;